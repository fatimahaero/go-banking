...
func (t *TransactionHandlerDB) CreateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Info().Msg("Invalid request body")
...
func (t *TransactionHandlerDB) GetTransactionByAccountID(w http.ResponseWriter, r *http.Request) {
	...
	log.Info().Msg("Get transaction by account ID")
	...
	log.Info().Str("account", id).Str("total", fmt.Sprintf("have: %+v transactions", len(transactions))).Msg("Transaction retrieved successfully")
...
func (t *TransactionHandlerDB) GetAllTransaction(w http.ResponseWriter, r *http.Request) {
	...
	log.Info().Msg("Get all transactions")
	...
	log.Info().Str("total", fmt.Sprintf("have: %+v transactions", len(transactions))).Msg("Transactions retrieved successfully")
}
